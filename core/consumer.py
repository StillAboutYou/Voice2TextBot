...
def process_task(ch, method, properties, body):
    try:
        ...
        logger.info(f"Получена задача: sender_id={sender_id}," +
                    f"message_id={message_id}, voice_url={voice_url}")
        ...
        connectionParams = pika.ConnectionParameters(host=config.RABBITMQ_HOST)
